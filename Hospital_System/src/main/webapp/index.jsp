...
<body>
	...
	<div class="container p-3">
		...
		<div class="row">
						...
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Hospitals do not tolerate physical or verbal aggression
									or abuse towards staff, patients, family members or visitors...</p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>The removal of dirt and germs from surfaces, so that the
									environment is a clean and hygienic space for patients...</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Respects their opinion, listens as they describe health
									issues and symptoms and asks questions in order to understand
									the cause of their illness...</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								...
								<p>Consider whether the hospital's location is safe and
									convenient for you, your family, friends, and advocate...</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-md-4">
				<img alt="" src="img/doct.jpg" height="340px" width="315px">
			</div>
